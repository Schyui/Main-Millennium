...
public class ActivityChinaStageThree extends AppCompatActivity {
    Timer timer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_china_stage_three);
        ...
        //music before battle
        menu = MediaPlayer.create(ActivityChinaStageThree.this, R.raw.intense);
        ...
        Restartbtn.setOnClickListener(v -> openActivityChinaStageThree());
        ...
        b_start.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                clicks = 0;
                time = 114;
                lunatic = MediaPlayer.create(ActivityChinaStageThree.this, R.raw.chinaboss);
                ...
                click = MediaPlayer.create(ActivityChinaStageThree.this, R.raw.battlestartsound);
                click.start();
        ...
        dnote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer = MediaPlayer.create(ActivityChinaStageThree.this, R.raw.correctsound);
        ...
        enote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                click2 = MediaPlayer.create(ActivityChinaStageThree.this, R.raw.slash);
                click2.start();
        ...
        gnote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                click = MediaPlayer.create(ActivityChinaStageThree.this, R.raw.bulletlaser);
    ...
    protected void openFinish() {
        ...
        click = MediaPlayer.create(ActivityChinaStageThree.this, R.raw.press);
        click.start();
    }
    protected void openActivityChinaStageThree() {
