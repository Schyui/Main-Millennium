...
public class StartActivityItalyStageTwo extends AppCompatActivity {
    Timer timer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.start_activity_italy_stage_two);
        ...
        //music before battle
        menu = MediaPlayer.create(StartActivityItalyStageTwo.this, R.raw.intense);
        ...
        Finishbtn.setOnClickListener(v -> openChapterThree());
        ImageButton Restartbtn = (ImageButton) findViewById(R.id.restart);
        Restartbtn.setOnClickListener(v -> openStartActivityItalyStageTwo());
        ...
        //timer
        timercount = new CountDownTimer(97000,1000) {
            @Override
        ...
        b_start.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                clicks = 0;
                time = 97;
                lunatic = MediaPlayer.create(StartActivityItalyStageTwo.this, R.raw.italyboss);
                ...
                click = MediaPlayer.create(StartActivityItalyStageTwo.this, R.raw.battlestartsound);
                click.start();
        ...
        bnote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer = MediaPlayer.create(StartActivityItalyStageTwo.this, R.raw.correctsound);
        ...
        dnote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                click2 = MediaPlayer.create(StartActivityItalyStageTwo.this, R.raw.slash);
                click2.start();
        ...
        anote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                click = MediaPlayer.create(StartActivityItalyStageTwo.this, R.raw.bulletlaser);
    ...
    //Back-finish Button
    protected void openChapterThree() {
        Intent intent = new Intent(this, ChapterThree.class);
        startActivity(intent);
        click = MediaPlayer.create(StartActivityItalyStageTwo.this, R.raw.press);
        click.start();
    }
    protected void openStartActivityItalyStageTwo() {
