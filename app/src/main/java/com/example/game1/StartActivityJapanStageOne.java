...
public class StartActivityJapanStageOne extends AppCompatActivity {
    Timer timer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.start_activity_japan_stage_one);
        ...
        //music before battle
        menu = MediaPlayer.create(StartActivityJapanStageOne.this, R.raw.intense);
        ...
        Finishbtn.setOnClickListener(v -> openChapterTwo());
        ImageButton Restartbtn = (ImageButton) findViewById(R.id.restart);
        Restartbtn.setOnClickListener(v -> openStartActivityJapanStageOne());
        ...
        //timer
        timercount = new CountDownTimer(110000,1000) {
            @Override
        ...
        b_start.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                clicks = 0;
                time = 110;
                lunatic = MediaPlayer.create(StartActivityJapanStageOne.this, R.raw.lunatic);
                ...
                slash.setVisibility(View.INVISIBLE);
                click = MediaPlayer.create(StartActivityJapanStageOne.this, R.raw.battlestartsound);
                click.start();
        ...
        gnote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer = MediaPlayer.create(StartActivityJapanStageOne.this, R.raw.correctsound);
        ...
        anote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                click2 = MediaPlayer.create(StartActivityJapanStageOne.this, R.raw.slash);
                click2.start();
        ...
        cnote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                click = MediaPlayer.create(StartActivityJapanStageOne.this, R.raw.bulletlaser);
    ...
    //Back-finish Button
    protected void openChapterTwo() {
        Intent intent = new Intent(this, ChapterTwo.class);
        startActivity(intent);
        click = MediaPlayer.create(StartActivityJapanStageOne.this, R.raw.press);
        click.start();
    }
    protected void openStartActivityJapanStageOne() {
