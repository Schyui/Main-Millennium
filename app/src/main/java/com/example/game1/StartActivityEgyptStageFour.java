...
public class StartActivityEgyptStageFour extends AppCompatActivity {
    Timer timer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.start_activity_egypt_stage_four);
        ...
        //music before battle
        menu = MediaPlayer.create(StartActivityEgyptStageFour.this, R.raw.intense);
        ...
        Finishbtn.setOnClickListener(v -> openChapterFive());
        ImageButton Restartbtn = (ImageButton) findViewById(R.id.restart);
        Restartbtn.setOnClickListener(v -> openStartActivityEgyptStageFour());
        ...
        idlejapananim.setBackgroundResource(R.drawable.idleegpytboss);
        ...
        atkjapananim.setBackgroundResource(R.drawable.idleegpytboss);
        ...
        //timer
        timercount = new CountDownTimer(79000,1000) {
            @Override
        ...
        b_start.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                clicks = 0;
                time = 79;
                lunatic = MediaPlayer.create(StartActivityEgyptStageFour.this, R.raw.egyptboss);
                ...
                click = MediaPlayer.create(StartActivityEgyptStageFour.this, R.raw.battlestartsound);
                click.start();
        ...
        enote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer = MediaPlayer.create(StartActivityEgyptStageFour.this, R.raw.correctsound);
        ...
        gnote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                click2 = MediaPlayer.create(StartActivityEgyptStageFour.this, R.raw.slash);
                click2.start();
        ...
        fnote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                click = MediaPlayer.create(StartActivityEgyptStageFour.this, R.raw.bulletlaser);
    ...
    //Back-finish Button
    protected void openChapterFive() {
        Intent intent = new Intent(this, ChapterFive.class);
        startActivity(intent);
        click = MediaPlayer.create(StartActivityEgyptStageFour.this, R.raw.press);
        click.start();
    }
