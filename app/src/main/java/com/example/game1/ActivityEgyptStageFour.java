...
public class ActivityEgyptStageFour extends AppCompatActivity {
    Timer timer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_egypt_stage_four);
        ...
        //music before battle
        menu = MediaPlayer.create(ActivityEgyptStageFour.this, R.raw.intense);
        ...
        Restartbtn.setOnClickListener(v -> openActivityEgyptStageFour());
        ...
        b_start.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                clicks = 0;
                time = 79;
                lunatic = MediaPlayer.create(ActivityEgyptStageFour.this, R.raw.egyptboss);
                ...
                click = MediaPlayer.create(ActivityEgyptStageFour.this, R.raw.battlestartsound);
                click.start();
        ...
        enote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer = MediaPlayer.create(ActivityEgyptStageFour.this, R.raw.correctsound);
        ...
        gnote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                click2 = MediaPlayer.create(ActivityEgyptStageFour.this, R.raw.slash);
                click2.start();
        ...
        fnote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                click = MediaPlayer.create(ActivityEgyptStageFour.this, R.raw.bulletlaser);
    ...
    protected void openFinish() {
        ...
        click = MediaPlayer.create(ActivityEgyptStageFour.this, R.raw.press);
        click.start();
    }
    protected void openActivityEgyptStageFour() {
