...
public class ActivityJapanStageOne extends AppCompatActivity {
    Timer timer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_japan_stage_one);
        ...
        //music before battle
        menu = MediaPlayer.create(ActivityJapanStageOne.this, R.raw.intense);
        ...
        Restartbtn.setOnClickListener(v -> openActivityJapanStageOne());
        ...
        b_start.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                clicks = 0;
                time = 110;
                lunatic = MediaPlayer.create(ActivityJapanStageOne.this, R.raw.lunatic);
                ...
                click = MediaPlayer.create(ActivityJapanStageOne.this, R.raw.battlestartsound);
                click.start();
        ...
        gnote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer = MediaPlayer.create(ActivityJapanStageOne.this, R.raw.correctsound);
        ...
        anote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                click2 = MediaPlayer.create(ActivityJapanStageOne.this, R.raw.slash);
                click2.start();
        ...
        cnote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                click = MediaPlayer.create(ActivityJapanStageOne.this, R.raw.bulletlaser);
    ...
    protected void openFinish() {
        ...
        click = MediaPlayer.create(ActivityJapanStageOne.this, R.raw.press);
        click.start();
    }
    protected void openActivityJapanStageOne() {
