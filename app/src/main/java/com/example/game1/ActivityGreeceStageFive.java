...
public class ActivityGreeceStageFive extends AppCompatActivity {
    Timer timer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_greece_stage_five);
        ...
        //music before battle
        menu = MediaPlayer.create(ActivityGreeceStageFive.this, R.raw.intense);
        ...
        Restartbtn.setOnClickListener(v -> openActivityGreeceStageFive());
        ...
        b_start.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                clicks = 0;
                time = 244;
                lunatic = MediaPlayer.create(ActivityGreeceStageFive.this, R.raw.tutorialmusic);
                ...
                click = MediaPlayer.create(ActivityGreeceStageFive.this, R.raw.battlestartsound);
                click.start();
        ...
        dnote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer = MediaPlayer.create(ActivityGreeceStageFive.this, R.raw.correctsound);
        ...
        gnote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                click2 = MediaPlayer.create(ActivityGreeceStageFive.this, R.raw.slash);
                click2.start();
        ...
        cnote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                click = MediaPlayer.create(ActivityGreeceStageFive.this, R.raw.bulletlaser);
    ...
    protected void openFinish() {
        ...
        click = MediaPlayer.create(ActivityGreeceStageFive.this, R.raw.press);
        click.start();
    }
    protected void openActivityGreeceStageFive() {
