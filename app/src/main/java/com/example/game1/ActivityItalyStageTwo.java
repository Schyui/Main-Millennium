...
public class ActivityItalyStageTwo extends AppCompatActivity {
    Timer timer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_italy_stage_two);
        ...
        //music before battle
        menu = MediaPlayer.create(ActivityItalyStageTwo.this, R.raw.intense);
        ...
        Restartbtn.setOnClickListener(v -> openActivityItalyStageTwo());
        ...
        b_start.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                clicks = 0;
                time = 97;
                lunatic = MediaPlayer.create(ActivityItalyStageTwo.this, R.raw.italyboss);
                ...
                click = MediaPlayer.create(ActivityItalyStageTwo.this, R.raw.battlestartsound);
                click.start();
        ...
        bnote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer = MediaPlayer.create(ActivityItalyStageTwo.this, R.raw.correctsound);
        ...
        dnote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                click2 = MediaPlayer.create(ActivityItalyStageTwo.this, R.raw.slash);
                click2.start();
        ...
        anote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                click = MediaPlayer.create(ActivityItalyStageTwo.this, R.raw.bulletlaser);
    ...
    protected void openFinish() {
        ...
        click = MediaPlayer.create(ActivityItalyStageTwo.this, R.raw.press);
        click.start();
    }
    protected void openActivityItalyStageTwo() {
