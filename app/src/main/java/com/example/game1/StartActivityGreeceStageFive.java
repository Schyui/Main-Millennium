...
public class StartActivityGreeceStageFive extends AppCompatActivity {
    Timer timer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.start_activity_greece_stage_five);
        ...
        //music before battle
        menu = MediaPlayer.create(StartActivityGreeceStageFive.this, R.raw.intense);
        ...
        Finishbtn.setOnClickListener(v -> openTheEnd());
        ImageButton Restartbtn = (ImageButton) findViewById(R.id.restart);
        Restartbtn.setOnClickListener(v -> openStartActivityGreeceStageFive());
        ...
        idlejapananim.setBackgroundResource(R.drawable.idlegreece);
        ...
        atkjapananim.setBackgroundResource(R.drawable.idlegreece);
        ...
        //timer
        timercount = new CountDownTimer(244000,1000) {
            @Override
        ...
        b_start.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                clicks = 0;
                time = 244;
                lunatic = MediaPlayer.create(StartActivityGreeceStageFive.this, R.raw.tutorialmusic);
                ...
                click = MediaPlayer.create(StartActivityGreeceStageFive.this, R.raw.battlestartsound);
                click.start();
        ...
        dnote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer = MediaPlayer.create(StartActivityGreeceStageFive.this, R.raw.correctsound);
        ...
        gnote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                click2 = MediaPlayer.create(StartActivityGreeceStageFive.this, R.raw.slash);
                click2.start();
        ...
        cnote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                click = MediaPlayer.create(StartActivityGreeceStageFive.this, R.raw.bulletlaser);
    ...
    //Back-finish Button
    protected void openTheEnd() {
        Intent intent = new Intent(this, TheEnd.class);
        startActivity(intent);
        click = MediaPlayer.create(StartActivityGreeceStageFive.this, R.raw.press);
        click.start();
    }
    protected void openStartActivityGreeceStageFive() {
        Intent intent = new Intent(this, StartActivityGreeceStageFive.class);
        startActivity(intent);
        click = MediaPlayer.create(StartActivityGreeceStageFive.this, R.raw.press);
        click.start();
    }
